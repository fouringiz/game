# Ultimate TD — EN Glossary (официальный словарь терминов, v1.1)
...
> **Изменения v1.0 → v1.1 (синхронизация с паспортом v2.5):** удалён Target Priority (переключатель выведен из канона — огонь строго автоматический); добавлены термины продажи башен, звёздного рейтинга, песочницы и теневого слоя документов (раздел 9-бис); зафиксированы официальные имена **Simulation Deck** (песочница) и **Sealed Annex** (документ за идеальное кольцо); в раздел 10 добавлены недостававшие Joint Resolution и Commander's Resolution; снято предупреждение о счёте мутаций (в паспорте v2.5 значится корректное 13).
...
| power gauge | энергошкала | горизонтальная в HUD; заливка и цветовая логика RA (зелёный/жёлтый/красный, насечка порога, мигание в браунауте) |
| brownout | браунаут | −40% скорострельности |
| tower pause / warm-up | пауза башни / прогрев | 2–3 с после снятия |
| tower sell / demolition | продажа башни / снос | возврат 60% (черновое); нашивки сгорают; доступна всегда; снос 1.5–2 с (огонь прекращается сразу, кредиты по завершении) |
| «Asset liquidated. Depreciation applied: 40%.» | строка Sato при продаже | лор-обёртка продажи |
| automatic targeting | автоматический таргетинг | огонь строго автоматический, игрокских контролей нет; база «дальше всех по тропе» |
| anti-overkill | анти-overkill | учёт летящего урона (внутренний термин) |
| automatic target order | порядок автоматических приоритетов | anti-overkill → уходящий Coordinator → присосавшаяся Leech → кластер пушки / самая дальняя цель |
| cluster targeting | кластерный выбор цели | пушка бьёт в скопление (внутренний термин) |
| Leech auto-escalation | авто-эскалация приоритета Пиявок | пиявка на генераторе становится приоритетной целью башен в радиусе |
| Generator | Генератор | уровни 1–3: +40 / +60 / +85 энергии; числа черновые до плейтеста |
...
| Veterancy: Regular → Veteran → Elite | ветеранство: обычная → ветеран → элита | «stripes» — нашивки; при продаже сгорают |
| FEAST ×N («THE SWARM FEASTS»)| «Пир» / «РОЙ ПИРУЕТ ×N» | баннер пиявок |
| Sated Waves | «Сытые волны» | украденное усиливает волны |

*Удалено в v1.1: Target Priority (First / Strongest / Airborne / Leeches) — переключатель выведен из канона.*
...
## 9-бис. Песочница, звёзды и теневой слой (новое в v1.1)

| EN | RU | Примечание |
|---|---|---|
| Simulation Deck | песочница-симулятор | ЗАФИКСИРОВАНО; тренажёр Командования; без Сигнатуры, Аномалий и последствий |
| «Simulation terminated. No biomaterial was harmed.» | строка проигрыша в симуляторе | черновая формулировка |
| star rating (★ / ★★ / ★★★) | звёздный рейтинг | чистота по HP Врат: победа / ≥70% / 100%; пороги черновые |
| collectible document | коллекционный документ узла | награда за ★★★; 27 шт.: Marsh field notes (раскопы), Sato internal memos (инфраструктура), Hayes fourth points (рубежи) |
| shadow layer | теневой слой | совокупное имя четвёртого канала повествования (27 + жемчужины) |
| Sealed Annex | «жемчужина» кольца (внутренний жаргон) | ЗАФИКСИРОВАНО; документ высшего яруса за все 9 узлов кольца на ★★★; открывается после прохождения шлюза в кампании; «ring pearl» в игровые тексты не выносится |
...
| Gateway Unsealing Order | все трое | приказ с тремя подписями |
| Joint Resolution | все трое | совместное решение (H-1 у Сердца — первое несобравшееся) |
| Commander's Resolution | Командующий | финальная подпись игрока, три варианта (Retain / Seal / Read) |
| Appropriation documents | по фракции | 21 документ узлов деревьев |
| Collectible documents (shadow layer) | по типу узла | 27 документов узлов + жемчужины колец (тексты — бэклог) |
